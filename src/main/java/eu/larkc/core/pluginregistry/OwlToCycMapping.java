...
/**
 * This class have hash table which maps the Cyc constants and predicates to
 * OWL, RDF predicates and constants
 * 
...
public class OwlToCycMapping {
	...
	public OwlToCycMapping() {
		...
		mapping.put("http://www.w3.org/1999/02/22-rdf-syntax-ns#Property",
				"BinaryPredicate");
		mapping.put("http://www.w3.org/2002/07/owl#TransitiveProperty",
				"TransitiveBinaryPredicate");

		mapping.put("http://www.w3.org/2001/XMLSchema#string",
				"CharacterString");
		...
		mapping.put("http://www.w3.org/2000/01/rdf-schema#isDefinedBy",
	 ...
	 * 
	 * @param rdfTerm
	 * @return true/false about the existance
	 */
	...
	public String toCycConst(String rdfTerm) {
		...
		rdfTerm = rdfTerm.replaceFirst("http://www.wsmo.org/ns/wsmo-lite#",
				"wsl-");
