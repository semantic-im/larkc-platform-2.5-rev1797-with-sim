 ...
 * 
 */
public class TestEndpointMain extends Endpoint {

	private static Logger logger = LoggerFactory
			.getLogger(TestEndpointMain.class);
	...
	public void start(int port) throws EndpointException {
		...
		component.getDefaultHost().attach("/testendpoint",
		...
		setPort(port);
		initialized = true;
		logger.info("Test endpoint started on port " + port);
	}
	...
	public void stop() throws EndpointShutdownException {
		...
		initialized = false;
		logger.info("Test endpoint on port " + getPort() + " stopped");
	}
	...
	public static void main(String[] args) throws Exception {
		// Just for testing
		new TestEndpointMain(new Executor(
