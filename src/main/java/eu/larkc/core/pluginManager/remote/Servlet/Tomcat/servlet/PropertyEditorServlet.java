...
public class PropertyEditorServlet extends LarkcServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		out.print(createForm(properties, request.getContextPath()
				+ "/properties"));
	}
	...
	private String createForm(Properties properties, String action) {
		...
		buffer.append("<HTML>");
		buffer.append("<HEAD>");
		buffer.append("  <TITLE>").append(getContextName())
				.append(" plugin properties editor</TITLE>");
		buffer.append("</HEAD>");
		...
		buffer.append("<br />");
		buffer.append("<H1 ALIGN=\"CENTER\">").append(getContextName())
				.append(" plug-in properties editor</H1>");

		// /servlet/hall.ShowParameters
		buffer.append("<FORM ACTION=\"").append(action)
				.append("\" METHOD=\"POST\">");
		buffer.append("  Properties:<BR />");
		// buffer.append( "  <TEXTAREA NAME=\"properties\" ROWS=10 COLS=80>"
		// ).append( stringisedProperties.toString() ).append(
		// "</TEXTAREA><BR />" );
		buffer.append(
				"  <TEXTAREA style=\"width: 98%\" NAME=\"properties\" ROWS=10>")
				.append(stringisedProperties.toString())
				.append("</TEXTAREA><BR />");
