 ...
 *
 */
public aspect QueryContextCreator extends AbstractContextCreator {

	public pointcut methodToCreateNewContext(): within(eu.larkc.core.endpoint.sparql.SparqlHandler) && execution(* handle(..));
