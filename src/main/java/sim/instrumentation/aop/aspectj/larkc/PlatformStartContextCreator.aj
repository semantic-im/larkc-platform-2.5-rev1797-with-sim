 ...
 *
 */
public aspect PlatformStartContextCreator extends AbstractContextCreator {

	public pointcut methodToCreateNewContext(): within(eu.larkc.core.Larkc) && execution(public static void main(..));

	@Override
	protected String[] getContextNameAndTag(JoinPoint jp) {
		return new String[] {"PlatformStart", "Platform"};
	}
